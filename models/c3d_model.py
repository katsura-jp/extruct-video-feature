...
class C3D(nn.Module):
    ...
    def forward(self, x):
        ...
        # pooling
        visual_feature = F.avg_pool1d(visual_feature.t().unsqueeze(0), 9).squeeze()
        visual_activity_concept = F.avg_pool1d(visual_activity_concept.t().unsqueeze(0), 9).squeeze()
